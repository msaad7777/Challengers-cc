          ...
          <div className="space-y-8">
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <p className="text-sm text-gray-500 mt-4">
                Follow us on <span className="text-primary-400">Instagram (@challengers.cc)</span> and <span className="text-primary-400">Facebook</span> for updates, match results, and events
              </p>
            </div>
          </div>
