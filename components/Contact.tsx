          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@challengerscc.ca" className="text-gray-400 hover:text-primary-400 transition-colors">
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <p className="text-sm text-gray-500 mt-4">
                Follow us on <span className="text-primary-400">Instagram (@challengers.cc)</span>, <span className="text-primary-400">Facebook</span>, and <span className="text-primary-400">YouTube</span> for updates, match results, livestreams, and events
              </p>
            </div>
          </div>
