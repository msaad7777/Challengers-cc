# Sponsorship & Funding Opportunities for Challengers Cricket Club

This document outlines potential sponsorship and funding opportunities for Challengers Cricket Club as a registered Ontario non-profit corporation.

## Provincial & National Organizations

### Cricket Ontario
**Organization Type**: Provincial Sport Organization (PSO)
**Tagline**: "Play Cricket, Grow Together"
**Website**: https://cricketontario.ca
**Contact Method**: Website contact form (name, email, message)
**Email List**: Available for updates, promotions, and more
**Social Media**: Facebook (@CricketOntario)

**Opportunities**:
- Partnership and affiliation programs
- Access to provincial championships
- Networking with other cricket clubs
- Visibility through provincial events
- Coaching and development programs
- Email list for staying updated on opportunities

**Action Items**:
- [ ] Submit contact form on cricketontario.ca introducing Challengers CC
- [ ] Sign up for Cricket Ontario email list for updates
- [ ] Inquire about club affiliation requirements and benefits
- [ ] Ask about partnership opportunities
- [ ] Explore provincial tournament hosting possibilities
- [ ] Request information about coaching certification programs

---

### Cricket Canada
**Organization Type**: National Sport Organization
**Website**: https://cricketcanada.org
**Contact**: Through website

**Recent Partnerships**:
- TD Bank Group (multi-year partnership announced April 2024)
- O'Neills Sportswear (multi-year partnership)

**Action Items**:
- [ ] Research national club development programs
- [ ] Inquire about equipment partnerships
- [ ] Explore national tournament opportunities

---

### Ontario Para Network (ONPARA)
**Organization Type**: Multi-Sport Organization (Wheelchair Basketball, Rugby, Tennis)
**Tagline**: "Growing adaptive sport opportunities across Ontario"
**Website**: https://www.onpara.ca
**Contact**: Doug Hannum, Executive Director - doug@onpara.ca
**Social Media**: Instagram (@onparanetwork), Facebook

**Mission**:
"Our mission at the Ontario Para Network is to grow opportunities for participation in adaptive sports. We lead, develop, support and advocate for athletes, coaches and volunteers to build strong and inclusive sport communities."

**Why This Matters for Challengers CC**:
While ONPARA is not a direct sponsor (they're a sports organization like us), they provide valuable opportunities:

**1. Learning from Their Fundraising Model**:
- **Drive to December Campaign** - Annual fundraising initiative (learn their approach)
- **Quest for Gold** - Athlete funding program (model for player support)
- **Donation Structure** - Prominent donation page and clear calls-to-action
- **Membership Tiers** - Different levels for different sports/participants
- **Corporate Programs** - They work with corporations (potential shared sponsors)

**2. Potential Partnership Opportunities**:
- **Inclusive Cricket Initiative** - Become Ontario's FIRST cricket club to offer adaptive cricket
- Partner with ONPARA to introduce cricket to their athlete community
- Co-host "Have a Go" cricket sessions for wheelchair users
- Cross-promote events and programs
- Build reputation as an innovative, inclusive sports organization

**3. Networking & Shared Corporate Sponsors**:
- Identify corporations that sponsor ONPARA's corporate programs
- Target companies that value inclusive/adaptive sports
- Learn their sponsor pitch strategies
- Explore co-sponsorship opportunities

**4. Community Impact & Visibility**:
- Joint community sports festivals
- Shared volunteer networks
- Enhanced visibility in London, Ontario
- Demonstrate commitment to inclusion and accessibility

**Their Programs to Study**:
- Bridging the Gap - Introductory programs
- School Programs - Youth engagement model
- Corporate Programs - Business partnership structure
- Volunteer recruitment and management
- Social media engagement strategy (very active on Instagram)

**Their Funding Sources to Research**:
- Individual donations
- Corporate partnerships
- Membership fees
- Equipment loan programs
- Provincial/national grants
- Tournament fundraising events (Para Tough Mudder, Para Spartan Race)

**Action Items**:
- [ ] Review ONPARA's Drive to December campaign model
- [ ] Study their corporate partnership structure
- [ ] Reach out to Doug Hannum about potential cricket collaboration
- [ ] Explore adaptive/inclusive cricket program feasibility
- [ ] Sign up for their newsletter for updates and ideas
- [ ] Identify corporations on their sponsor list to approach
- [ ] Consider co-hosting a community sports event
- [ ] Learn from their social media engagement strategy

**Potential Innovative Angle**:
If Challengers CC becomes the first cricket club in Ontario to offer adaptive cricket programs, it could:
- Attract unique sponsors interested in innovation and inclusion
- Gain media attention and visibility
- Access funding streams specific to inclusive sports
- Build strong community relationships
- Differentiate from other cricket clubs in the region
...
### City of London Recreation & Sports Funding
**Administrator**: City of London
**Department**: Recreation and Sports

**Action Items**:
- [ ] Contact City of London Parks & Recreation department
- [ ] Inquire about municipal grants for amateur sports clubs
- [ ] Ask about facility rental subsidies for non-profits
- [ ] Explore community partnership programs

---

### KidSport Ontario - Provincial Fund
**Organization Type**: Youth Sports Grant Program
**Website**: https://kidsportcanada.ca/ontario/provincial-fund/
**Contact**: info@kidsportontario.ca | 416-899-9106
**Mailing Address**: PO Box 93004 Headon RPO, Burlington, Ontario L7M 4A3

**Mission**: Removes financial barriers for youth sports participation

**What KidSport Does**:
- Provides grants to kids from families facing financial barriers
- Grants of **up to $250 per eligible child, per year** (January 1 - December 31)
- Covers sport registration fees (grants paid directly to sport programs)
- Equipment referrals to partner agencies
- Based on federal government low income guidelines plus approximately 30%

**CRITICAL REQUIREMENT for Challengers CC**:
⚠️ **Sport clubs must be members of their respective Provincial Sport Organization**
- This means Challengers CC MUST join **Cricket Ontario** to be a KidSport partner program
- This reinforces the importance of Cricket Ontario affiliation

**How This Benefits Challengers CC**:

**1. Youth Program Growth** 📈
- Kids from low-income families can join Challengers youth cricket
- Expand youth participation without turning families away
- Build larger, more diverse player base
- Create pathway from youth to senior teams

**2. Direct Revenue Stream** 💰
- KidSport pays Challengers CC directly for registration fees
- Guaranteed payment for youth participants
- Reduces family collection/payment issues
- Predictable youth program revenue

**3. Enhanced Sponsor Appeal** 🌟
- Demonstrate community impact in sponsor proposals
- Show commitment to inclusivity and accessibility
- Provide concrete participation data (# of kids served)
- Attract sponsors who value social responsibility
- Stronger grant applications with youth participation metrics

**4. Community Reputation** 🏆
- Position Challengers CC as community-focused organization
- Build goodwill with families and local government
- Media opportunities ("Club serves ALL kids regardless of income")
- Differentiate from other cricket clubs in region

**5. Long-term Player Development** 🎯
- Youth who start young become lifelong players
- Build loyalty and community connections
- Create future coaches and volunteers
- Strengthen club sustainability

**Application Process for Families**:
1. Family signs up child for Challengers youth cricket program
2. Family informs Challengers CC they're applying for KidSport funding
3. Family applies online or via paper application
4. KidSport processes application within 30 days
5. If approved, grant sent directly to Challengers CC
6. Child participates in full season of cricket

**Eligibility Documentation Required**:
Families must provide one of:
- Canada Child Benefit Notice (preferred)
- Proof of Income Statement (CRA My Account)
- Notice of Assessment (most recent tax year)
- Income Support documentation
- Subsidized Housing documentation
- Child Health Benefit letter

**2026 Application Deadlines**:
- Apply by **Friday, November 7th, 2025** for programs running January-February 2026
- Applications processed within 30 days

**What Grants Cover**:
✅ Sport registration fees
❌ NOT covered: Travel, competitions, equipment (equipment referred to partners)

**Action Items for Challengers CC**:
- [ ] Join Cricket Ontario (REQUIRED to partner with KidSport)
- [ ] Register as a KidSport partner sport program
- [ ] Add KidSport information to youth registration page
- [ ] Include KidSport logo on website and promotional materials
- [ ] Train registration staff on KidSport process
- [ ] Create simplified guide for families on how to apply
- [ ] Track KidSport participation for sponsor proposals
- [ ] Include KidSport partnership in all sponsor pitches
- [ ] Promote KidSport availability through social media
- [ ] Partner with local schools to reach eligible families

**How to Present This to Sponsors**:
In sponsor proposals, include language like:
> "Challengers Cricket Club is proud to partner with KidSport Ontario to ensure ALL youth in London can participate in cricket, regardless of family income. In [YEAR], we served [X] youth through KidSport funding, demonstrating our commitment to community accessibility and inclusion."

**Marketing Value**:
- Social media posts about KidSport partnership
- Local media stories ("Cricket club opens doors to all kids")
- Community recognition as inclusive organization
- Enhanced credibility with municipal government
- Stronger position for facility access and grants

**Partner with KidSport National Partners** (shown on their site):
Research these organizations as they support KidSport and may sponsor Challengers CC:
- Check KidSport's national partner list
- Approach companies that fund youth sports accessibility
- Mention KidSport partnership in pitch
...
**Administrator**: Ministry of Tourism, Culture and Sport
**Website**: http://www.grants.gov.on.ca
**Application System**: Transfer Payment Ontario (TPON)

**🎯 MAJOR FUNDING OPPORTUNITY** - This is potentially the **BIGGEST** funding source available to Challengers CC!

**Overview**:
Provincial government program providing substantial funding to organizations hosting national and international sporting events in Ontario.

**Funding Levels**:

**Stream 1: National Events**
- **Up to $100,000** per event
- Sanctioned by national sport organization (Cricket Canada)
- Must have provincial, territorial, or international participation
- Examples: National T20 Championship, Canadian Cricket League Finals

**Stream 2: International Events**
- **Up to $1,000,000** per event
- Sanctioned by international sport organization (ICC)
- Must have athletes from multiple countries
- Examples: ICC Americas Championship, Commonwealth Cricket Tournament

**Eligibility for Challengers CC**:
✅ **Stream 2 Applicant** - Not-for-profit organizations incorporated in Ontario
✅ **Registered Ontario NFP Corporation** (#1746974-8) - WE QUALIFY!
✅ Can apply for both national and international events

**CRITICAL REQUIREMENT**:
⚠️ **Must be endorsed by Cricket Ontario** (Provincial Sport Organization)
- This again reinforces the absolute necessity of joining Cricket Ontario
- Endorsement letter required as part of application
- Cricket Ontario must confirm the event aligns with provincial sport development goals

**Application Deadlines for 2025-2026**:

**Intake #1**:
- **Deadline**: January 13, 2025 (11:59 PM EST)
- **Event Period**: April 1, 2025 - March 31, 2026

**Intake #2**:
- **Deadline**: July 14, 2025 (11:59 PM EST)
- **Event Period**: October 1, 2025 - September 30, 2026

**⏰ URGENT**: The January 13, 2025 deadline is approaching! If Challengers CC wants to host an event in 2025, we need to move quickly.

**Application Requirements**:

**1. Event Proposal & Budget**:
- Detailed event budget (revenues and expenses)
- Government funding cannot exceed **35% of total event budget**
- Must demonstrate other revenue sources (sponsors, ticket sales, etc.)

**2. Endorsement Letters**:
- Letter from **Cricket Ontario** (Provincial Sport Organization)
- Confirms event supports provincial sport development
- Demonstrates event fills gap in Ontario's sport hosting portfolio

**3. Sanctioning Letter**:
- From **Cricket Canada** (for national events)
- From **International Cricket Council - ICC** (for international events)
- Confirms event is officially recognized by governing body

**4. Economic Impact Report**:
- Must use approved models: **TREIM** or **STEAM**
- Demonstrates event's economic benefit to Ontario
- Includes visitor spending, job creation, tax revenue
- Template available through Sport Hosting program

**5. Deficit Guarantee Letter**:
- From organization's board of directors
- Guarantees organization will cover any event deficit
- Shows financial responsibility and planning

**6. Legacy Plan**:
- How the event benefits Ontario sport long-term
- Infrastructure improvements
- Youth development programs
- Increased participation in cricket
- Community engagement outcomes

**7. Accessibility Plan**:
- Ensures event is accessible to all Ontarians
- Venue accessibility features
- Inclusive programming
- Accommodations for athletes and spectators with disabilities
...
For a **$150,000 National Cricket Tournament**:
- Ontario Sport Hosting Program: **$52,500** (35% maximum)
- Corporate Sponsors: $60,000
- Ticket Sales: $20,000
- Cricket Ontario Support: $10,000
- Other Revenue (merchandise, concessions): $7,500
...
✅ Athlete accommodations and meals
✅ Equipment rental
✅ Event insurance
...
**Strategic Event Ideas for Challengers CC**:

**Year 1 (2026) - Build Foundation**:
1. **Ontario Provincial Cricket Championship** (National Stream - $50K-$100K)
   - Partner with Cricket Ontario
   - All Ontario cricket clubs participate
   - Held in London, ON

2. **Canadian T20 Club Championship** (National Stream - $75K-$100K)
   - Top club teams from across Canada
   - Cricket Canada sanctioned
   - Showcase London as cricket destination

**Year 2-3 (2027-2028) - Scale Up**:
3. **ICC Americas T20 Championship** (International Stream - $300K-$500K)
   - Teams from USA, Canada, Bermuda, Cayman Islands
   - ICC sanctioned
   - International media coverage

4. **Commonwealth Cricket Festival** (International Stream - $500K-$1M)
   - Invite teams from Commonwealth nations
   - Multi-format tournament
   - Cultural festival alongside cricket

**Why This Is HUGE for Challengers CC**:

**1. Massive Funding** 💰
- Single event could bring $100K-$1M to the club
- Covers venue, staffing, marketing costs
- Allows world-class event hosting

**2. National/International Visibility** 🌍
- Put Challengers CC and London, ON on the cricket map
- Media coverage across Canada and internationally
- Attract new members and sponsors

**3. Sponsor Attraction** 🎯
- Sponsors love being associated with major events
- Event naming rights opportunities
- Logo placement on all event materials
- VIP hospitality packages for sponsors

**4. Community Impact** 🏆
- Economic boost to London (hotels, restaurants, tourism)
- Youth inspiration and development
- Cricket growth in Ontario
- Legacy infrastructure improvements

**5. Club Credibility** ⭐
- Positions Challengers CC as major player in Canadian cricket
- Strengthens relationship with Cricket Ontario and Cricket Canada
- Opens doors for future partnerships and funding

**Application Process**:

**Step 1: Pre-Application** (2-3 months before deadline)
1. Join Cricket Ontario (CRITICAL first step)
2. Contact Cricket Ontario about event endorsement
3. Connect with Cricket Canada/ICC about sanctioning
4. Identify potential venues in London
5. Create preliminary budget

**Step 2: Application Development** (1-2 months before deadline)
1. Register for TPON (Transfer Payment Ontario) system
2. Complete online application form
3. Develop detailed event budget
4. Prepare economic impact report (TREIM/STEAM model)
5. Write legacy plan
6. Create accessibility plan
7. Develop marketing strategy

**Step 3: Submit Supporting Documents**
1. Endorsement letter from Cricket Ontario
2. Sanctioning letter from Cricket Canada/ICC
3. Deficit guarantee from Challengers CC Board
4. All required plans and reports
5. Submit before deadline (11:59 PM EST)

**Step 4: Review Process** (6-8 weeks)
- Ministry reviews application
- May request additional information
- Site visits possible for large events
- Decision communicated via TPON

**Step 5: If Approved**
- Transfer payment agreement signed
- Funding released in installments (typically 3)
- Event execution
- Post-event reporting and final payment

**Action Items for Challengers CC**:

**IMMEDIATE** (This Week):
- [ ] Review application deadlines (January 13 or July 14, 2025)
- [ ] Decide on potential event to host (National or International)
- [ ] Contact Cricket Ontario about membership and event endorsement
- [ ] Research potential venues in London, ON

**SHORT-TERM** (This Month):
- [ ] Join Cricket Ontario as affiliated club
- [ ] Register for TPON system access
- [ ] Contact Cricket Canada about sanctioning requirements
- [ ] Identify 3-5 potential event concepts
- [ ] Create preliminary budget for chosen event

**MEDIUM-TERM** (Next 2-3 Months):
- [ ] Secure Cricket Ontario endorsement letter
- [ ] Obtain Cricket Canada sanctioning letter
- [ ] Complete economic impact assessment (TREIM/STEAM)
- [ ] Draft legacy plan (how event benefits Ontario cricket)
- [ ] Develop accessibility plan for event
- [ ] Prepare deficit guarantee letter from Board
- [ ] Create marketing and promotion plan

**APPLICATION READY** (Before Deadline):
- [ ] Submit complete application via TPON
- [ ] Upload all supporting documents
- [ ] Confirm receipt from Ministry
- [ ] Respond to any follow-up requests

**Resources & Tools**:

**TPON System**:
- Website: https://www.ontario.ca/page/transfer-payment-ontario-system
- Online application portal for all Ontario government grants
- Requires organizational registration
- Secure document upload

**Economic Impact Models**:
- **TREIM** (Tourism Regional Economic Impact Model)
- **STEAM** (Sport Tourism Economic Assessment Model)
- Templates and guidance available through Sport Hosting program
- Can hire consultants for complex events

**Sport Hosting Support**:
- Email: SportHosting@ontario.ca
- Phone: 416-325-1444
- Request application guidelines and templates
- Ask questions about eligibility and process

**Cricket Ontario Contact**:
- Website: https://cricketontario.ca
- Discuss event ideas and endorsement process
- Align event with provincial development goals

**Cricket Canada Contact**:
- Website: https://cricketcanada.org
- Discuss national event sanctioning
- Explore partnership opportunities

**Timeline Example for January 13, 2025 Deadline**:

**November 15-30, 2024** (DONE ✅):
- Research Sport Hosting Program
- Review eligibility and requirements
- Identify potential event concepts

**December 1-15, 2024** (URGENT):
- Join Cricket Ontario
- Contact Cricket Ontario about endorsement
- Contact Cricket Canada about sanctioning
- Register for TPON system
- Select primary event concept

**December 16-31, 2024** (CRITICAL):
- Develop detailed event budget
- Complete economic impact report
- Draft legacy plan and accessibility plan
- Secure endorsement letter from Cricket Ontario
- Obtain sanctioning letter from Cricket Canada

**January 1-10, 2025** (FINAL PUSH):
- Complete TPON application
- Upload all supporting documents
- Board approves deficit guarantee
- Final review of all materials
- Submit application

**January 13, 2025** (DEADLINE):
- Application submitted by 11:59 PM EST

**Potential Risks & Mitigation**:

**Risk 1: Not enough time to join Cricket Ontario**
- **Mitigation**: Contact Cricket Ontario immediately, explain urgency
- **Alternative**: Apply for July 14 deadline instead

**Risk 2: Cannot secure sanctioning in time**
- **Mitigation**: Start with smaller provincial event for first application
- **Alternative**: Partner with existing sanctioned event

**Risk 3: Economic impact report too complex**
- **Mitigation**: Use simplified STEAM model for smaller events
- **Alternative**: Hire sport consulting firm for assistance

**Risk 4: Event deficit concerns**
- **Mitigation**: Start with smaller national event ($50K-$100K range)
- **Alternative**: Secure sponsor commitments before application

**Success Factors**:

✅ **Strong Cricket Ontario relationship** - Essential for endorsement
✅ **Realistic budget** - Don't overestimate revenues or underestimate costs
✅ **Clear legacy plan** - Show long-term benefit to Ontario cricket
✅ **Community support** - Letters from City of London, local businesses
✅ **Professional presentation** - Well-written application with supporting data
✅ **Experienced team** - Include board members with event management experience

**How to Present This to Board**:

> "The Ontario Sport Hosting Program offers Challengers Cricket Club the opportunity to secure $100,000 to $1,000,000 in government funding to host major cricket events in London, Ontario. By hosting a national or international cricket tournament, we can:
>
> 1. Generate massive visibility for our club and the sport in Ontario
> 2. Attract significant sponsors and partners
> 3. Build our reputation as a premier cricket organization
> 4. Create economic impact for London's tourism sector
> 5. Develop youth cricket programs through event legacy
>
> **CRITICAL REQUIREMENT**: We MUST join Cricket Ontario immediately to be eligible for endorsement.
>
> **URGENT TIMELINE**: If we want to apply for the January 13, 2025 deadline, we need to act NOW. Otherwise, we target the July 14, 2025 deadline for an event in late 2025 or 2026."

**Recommended First Event**:

**Ontario Provincial T30 Cricket Championship - Summer 2026**

**Event Concept**:
- First-ever provincial T30 championship
- All Cricket Ontario affiliated clubs invited
- Held at premier London venue
- 2-day weekend tournament
- Youth cricket clinic alongside main event

**Funding Request**: $75,000 (National Stream)

**Total Event Budget**: $215,000
- Sport Hosting Program: $75,000 (35%)
- Corporate Sponsors: $80,000
- Ticket Sales: $25,000
- Cricket Ontario Support: $20,000
- Merchandise & Concessions: $15,000

**Why This Works**:
✅ Achievable in first year
✅ Strong Cricket Ontario support (provincial championship)
✅ Manageable budget and risk
✅ Builds experience for larger events
✅ Creates template for future applications
✅ Establishes Challengers CC as event host
...
#### Tier 1: National Brands with Sports Sponsorship History

**RBC (Royal Bank of Canada)**
- **Focus**: Amateur sport from grassroots to associations
- **Approach**: Community-based sponsorships
- **Contact**: Local branch or community relations

**Canadian Tire**
- **Focus**: Youth sports across Canada
- **Approach**: Local community programs
- **Contact**: Local store managers or corporate community relations

**Tim Hortons**
- **Program**: Timbits Minor Sports (300,000+ youth athletes)
- **Sports**: Hockey, baseball, lacrosse, soccer, softball
- **Note**: Currently doesn't list cricket, but worth approaching
- **Contact**: Local franchisees or corporate sponsorship team

**BMO (Bank of Montreal)**
- **Focus**: Youth sports leagues (18,000+ participants in soccer alone)
- **Approach**: League and team sponsorships
- **Contact**: Local branch or corporate community investment

**CIBC**
- **Focus**: Amateur sports and community programs
- **Contact**: Local branch or corporate sponsorship

**TD Bank**
- **Recent**: Multi-year partnership with Cricket Canada (2024)
- **Focus**: Cricket development in Canada
- **Contact**: This is a HIGH PRIORITY target given their cricket partnership

---

#### Tier 2: Regional & Local Opportunities

**London, Ontario Specific Companies**:
- [ ] Research London-based corporations
- [ ] Contact London Chamber of Commerce for potential partners
- [ ] Explore London Economic Development Corporation partnerships

**Industries to Target**:
- **Financial Services**: Banks, credit unions, insurance companies
- **Automotive**: Dealerships, auto parts stores
- **Food & Beverage**: Restaurants, grocery stores, breweries
- **Healthcare**: Clinics, dental offices, physiotherapy centers
- **Technology**: IT companies, telecom providers
- **Real Estate**: Property developers, realty companies
- **Construction**: Contractors, building suppliers
- **Professional Services**: Accounting firms, law offices

---

#### Tier 3: Cricket Equipment & Apparel Companies

**International Cricket Brands**:
- **Prophecy Cricket** - Player sponsorship programs
- **Trogon Cricket** - Player sponsorship opportunities
- **Bolt Cricket** - Sponsorship applications
- **B3 Cricket** - Equipment sponsorship
- **Gecko Cricket** - Club sponsorship

**Action Items**:
- [ ] Apply for equipment sponsorships
- [ ] Negotiate bulk purchase discounts
- [ ] Explore jersey/kit sponsorship deals

---

## Sponsorship Package Tiers

Based on your existing sponsorship page structure:

### Title Sponsor ($25,000+)
- Primary branding on all jerseys
- Stadium naming rights (if applicable)
...
- Jersey back placement
- Website listing
- Event participation
- Social media mentions

### Community Partner ($1,000 - $4,999)
- Website listing
- Social media recognition
- Community goodwill
...
## Sponsorship Approach Strategy

### Phase 1: Immediate Actions (Month 1)
1. Join Cricket Ontario as affiliated club
2. Apply for City of London recreation grants
3. Contact TD Bank about their Cricket Canada partnership
4. Reach out to 5 local London businesses

### Phase 2: Build Relationships (Months 2-3)
1. Attend Cricket Ontario events
2. Network with other cricket clubs
3. Develop case studies from initial sponsors
4. Create sponsorship impact reports

### Phase 3: Scale Up (Months 4-6)
1. Apply for Ontario Amateur Sport Fund (when open)
2. Target national corporate sponsors
3. Explore equipment partnerships
4. Develop multi-year sponsorship renewals
...
- Customize proposals for each sponsor tier
- Include club mission, demographics, reach
- Show community impact and visibility metrics
...
### Contact Tracking
- Maintain spreadsheet of all sponsor contacts
...
Website: challengerscc.ca
Instagram: @challengers.cc

**Legal Status**: Registered Ontario NFP Corporation #1746974-8
...
1. **Immediate** (This Week):
   - Contact Cricket Ontario about affiliation
   - Research City of London grant programs
   - Compile list of 20 local London businesses

2. **Short-term** (This Month):
   - Prepare sponsorship proposal packages
   - Contact TD Bank about cricket sponsorship
   - Apply for equipment sponsorships

3. **Medium-term** (Next 3 Months):
   - Join Cricket Ontario
   - Apply for available grants
   - Secure 3-5 local sponsors

4. **Long-term** (6-12 Months):
   - Renew and expand sponsorships
   - Apply for Ontario Amateur Sport Fund
   - Host sponsored cricket events
