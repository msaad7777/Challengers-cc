              ...
              <a href="/c3h/pavilion" className="glass rounded-2xl p-6 border-2 border-accent-500/20 hover:border-accent-500/50 transition-all duration-300 block">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  {isDirector
                    ...
                    : 'Read the Club’s governance documents (Technology Governance Record, Letter of Direction, President Appointment) for visibility into the Club’s digital and operational arrangements. Signing trackers and board resolutions are reserved for directors.'}
                </p>
