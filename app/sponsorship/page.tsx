      ...
      <section className="section-padding bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass rounded-2xl p-8 border-2 border-white/10 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-accent-500/20 text-accent-400 text-xs font-bold px-3 py-1 rounded-full">
                COMING SOON
              </div>
              <div className="w-12 h-12 rounded-xl bg-primary-500/10 border border-primary-500/30 flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
