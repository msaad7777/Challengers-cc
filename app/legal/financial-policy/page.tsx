          ...
          <div className="glass rounded-2xl p-6 sm:p-8 border border-white/10 space-y-6 text-gray-200 leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-2 mt-2 text-sm list-disc list-inside ml-2">
                ...
                <li><strong className="text-white">Audit trail of changes.</strong> The Club&apos;s accounting system (Wave Accounting) maintains a change-log of all entries. Any entry that is later modified retains its original record alongside the modification, with the date and user who made the change. The Treasurer may not delete or overwrite historical entries. Working spreadsheets used to draft or reconcile entries (e.g. Google Sheets in the Club&apos;s <strong className="text-white">contact@challengerscc.ca</strong> Workspace Drive) are subject to Google Workspace Admin audit logging, which records every view, edit, share, and download with the user, timestamp, IP address, and device — these logs are reviewable by the Workspace administrator if a record-integrity dispute arises.</li>
