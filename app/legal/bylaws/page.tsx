        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="glass rounded-2xl p-6 sm:p-8 border border-white/10 space-y-6 text-gray-200 leading-relaxed text-sm">
            ...
            <section>
              ...
              <p>10.1 The Club <strong className="text-white">does not own</strong> the software, source code, designs, or cloud infrastructure that operate the Club&apos;s website (<code className="text-primary-400">challengerscc.ca</code>) or the C3H members&apos; portal. Those works are the intellectual property of <strong className="text-white">Saad Cloud &amp; AI Solutions Inc.</strong>, an Ontario business corporation owned by Mohammed Saad, who authored them in his personal capacity.</p>
              <p>10.2 The Club uses the platform under a <strong className="text-white">limited, non-exclusive, non-transferable, revocable licence</strong> from Saad Cloud &amp; AI Solutions Inc. The licence is provided <strong className="text-white">at no charge</strong> for so long as Mohammed Saad continues to serve as a director of the Club and Saad Cloud &amp; AI Solutions Inc. elects to continue providing the platform. The licence is <strong className="text-white">not perpetual and not irrevocable</strong>. The licence is recorded in the Club&apos;s <Link href="/legal/ip-ownership" className="text-primary-400 underline hover:text-primary-300">Software &amp; IP Ownership Acknowledgement</Link> and is to be formalized in a separate Software License &amp; Service Agreement signed by the board.</p>
              <p>10.2.1 Saad Cloud &amp; AI Solutions Inc. <strong className="text-white">retains the unilateral right</strong> to terminate the licence and withdraw the platform — frontend, backend, source code, deployments, cloud infrastructure, and all related setup — at its sole discretion on reasonable written notice (no less than thirty days unless terminated for cause). If Mohammed Saad ceases to be a director of the Club for any reason, the no-charge arrangement may be wound down, re-priced at fair market value, or terminated. On termination, the Club&apos;s right to use the platform ends and the Club has no claim to the source code, deployments, or infrastructure.</p>
              <p>10.3 The Club <strong className="text-white">shall not assert</strong> ownership, co-ownership, royalty rights, or revenue-share rights over any software, source code, design, or derivative work contributed to the Club by Mohammed Saad or by Saad Cloud &amp; AI Solutions Inc. The Club&apos;s use is limited to its own internal operations as a volunteer-run not-for-profit. The Club may not sublicense, resell, white-label, or commercialize the platform, nor demand assignment or escrow of source code.</p>
              ...
              <p>10.5 The Club acknowledges that Saad Cloud &amp; AI Solutions Inc. <strong className="text-white">reserves the right</strong> to develop, market, and sell multi-tenant or commercial versions of the platform to other organizations under its own branding, with no obligation to the Club. Member data of the Club shall not be used for any such commercial product without explicit member consent and a separate Data Processing Agreement.</p>
