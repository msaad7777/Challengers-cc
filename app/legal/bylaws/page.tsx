    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-950 to-black">
      ...
      <section className="section-padding pt-32 md:pt-40">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Governance status callout — shown on all three primary public
              legal pages (Bylaws, Privacy, Financial Policy). Single source
              of truth in app/legal/_shared/GovernanceStatusCallout.tsx */}
          ...
          <div className="glass rounded-2xl p-6 sm:p-8 border border-white/10 space-y-6 text-gray-200 leading-relaxed text-sm">
            ...
            <section>
              ...
              <p>1.2 The principal mailing address of the Club is: <strong className="text-white">790 Capulet Lane, London, ON N6H 0J8</strong>. The mailing address of an NFP under the CNCA is permitted to be the home address of a director and may be changed from time to time by Board resolution; any change is filed with Corporations Canada. The current address is the residence of the Club&apos;s incumbent Director, Mohammed Saad.</p>
            ...
            <section>
              ...
              <p>4.9 <strong className="text-white">Officer Removal by Director Vote.</strong> Any officer of the Corporation, whether or not they have e-signed the Officer Appointment Letter, may be removed from office at any time, with documented good-faith grounds, by an Ordinary Resolution of the Board of Directors (a majority of votes cast at a duly-called meeting of the Board at which a quorum is present). The procedure shall be:</p>
              <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <p className="text-xs text-gray-500 italic">
              Document version: v2.2 (2026-05-20) · Pending pro-bono lawyer review and member confirmation at first AGM. <br />
              v2.2 (2026-05-20) — Article 1.2 mailing address corrected to drop the unit number (&ldquo;Unit 907&rdquo;) so that the bylaws match the registered office as filed with Corporations Canada under Corporation #1746974-8, which records the address as <strong className="text-gray-400">790 Capulet Lane, London, ON N6H 0J8</strong>. No member-substantive amendment; this is a clerical correction to align the bylaws text with the federal filing. <br />
              v2.1 (2026-05-08) — Article 1.2 mailing address updated from 3228 Meadowgate Blvd, London, ON N6M 0B7 to <strong className="text-gray-400">790 Capulet Lane, London, ON N6H 0J8</strong> (residence of incumbent Director Mohammed Saad). Address change to be filed with Corporations Canada by the Secretary or designated Director. Article 4.9 / 4.10 / 4.10.1 / 4.10.2 / 4.12 strengthened to align with CNCA s. 130 / 141 / 143 statutory voting-rights protections. <br />
